...
6. `check:department-lifecycle`
7. scope/citation/live-preference checks (via `ci:validate`)
8. GitHub check `Publisher PR Contract` (enforces publisher title/body/branch conventions)
